                ...
                <View style={listStyle.container}>
                    <ScrollView style={listStyle.content}>
                        <View>
                            ...
                            <View style={{width:'100%',backgroundColor:'#fff',marginBottom:20}}>
                                <TouchableOpacity style={listStyle.item} >
                                    <View style={listStyle.itemDesc}>
                                        <Text style={listStyle.listTitle}>移交人部门</Text>
                                    </View>
                                    <View style={{
                                ...
                                <TouchableOpacity style={listStyle.item}>
                                    <View style={listStyle.itemDesc}>
                                        <Text style={listStyle.listTitle}>移交人</Text>
                                    </View>
                                    <View style={{
                            ...
                            <View style={styles.formRepair}>
                                <View style={styles.formRepairDivTitle}>
                                    <Text style={styles.formRepairTitleLabel}>移交拍照</Text>
                    ...
                    <TouchableOpacity style={listStyle.button}>
                        <Text style={listStyle.textButton}>立即移交</Text>
                    </TouchableOpacity>
                </View>
            </View>
        )
